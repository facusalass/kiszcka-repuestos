...
export function CatalogSection() {
  ...
  return (
    <section 
      id="catalogo"
      className="relative scroll-mt-24 py-14 md:py-24 bg-slate-50 border-t border-slate-200 w-full"
    ...
    >
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8">
          ...
          {categories.map((category, index) => (
            ...
            >
              ...
              <div className="p-5 sm:p-6 md:p-8 flex flex-col flex-grow relative bg-white">
                ...
                <h3 className="text-lg md:text-xl font-bold text-[#0B1E3B] mb-3 font-montserrat tracking-tight leading-tight">
                  {category.name}
                </h3>
                ...
                {/* Botón Consultar (Ghost Button Style) */}
                <a
        ...
        {/* Banner CTA (Llamado a la Acción Fuerte) */}
