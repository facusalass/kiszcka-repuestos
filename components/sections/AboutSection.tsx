        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="pr-0 lg:pr-8 scroll-reveal">
            ...
            <div className="space-y-5 sm:space-y-6 text-slate-500 font-light text-base md:text-lg leading-relaxed">
              ...
              <p>
                No somos simples vendedores de repuestos. A lo largo de los años, nos especializamos en conocer al detalle cada componente de tu unidad. Esta dedicación técnica es lo que nos permite construir relaciones de confianza duraderas con flotas, cooperativas y talleres de todo el país.
              </p>
          ...
          <div className="space-y-4 sm:space-y-5 scroll-reveal">
            <div className="tap-card group bg-slate-50 p-5 sm:p-6 md:p-8 rounded-xl border border-slate-100 hover:border-slate-300 active:border-slate-300 hover:shadow-lg active:shadow-lg transition-all duration-300 flex items-start sm:items-center gap-4 sm:gap-6">
              ...
              <div>
                <h3 className="tap-title text-2xl md:text-3xl font-black text-[#0B1E3B] font-montserrat tracking-tight mb-1">
                  +35 Años
                </h3>
