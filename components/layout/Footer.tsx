...
export function Footer() {
  return (
    <footer className="bg-[#0B1E3B] text-white pt-10 md:pt-12 pb-8 border-t-[4px] border-[#22D3EE] w-full">
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid md:grid-cols-12 gap-8 lg:gap-12 mb-10 scroll-reveal">
          ...
          <div className="md:col-span-4 lg:col-span-5">
            ...
            <p className="text-slate-400 text-[14px] md:text-[15px] font-light leading-relaxed pr-0 md:pr-4">
          ...
          <div className="md:col-span-4 lg:col-span-3">
            <h4 className="text-base font-bold mb-5 text-white uppercase tracking-wider font-montserrat">Navegación</h4>
            <ul className="space-y-3">
              <li>
                <Link href="#inicio" className="text-slate-400 font-light hover:text-[#22D3EE] transition-colors flex items-center gap-2 text-[14px] md:text-[15px]">
                  <ChevronRight className="w-4 h-4" /> Inicio
                </Link>
              </li>
              <li>
                <Link href="#catalogo" className="text-slate-400 font-light hover:text-[#22D3EE] transition-colors flex items-center gap-2 text-[14px] md:text-[15px]">
                  <ChevronRight className="w-4 h-4" /> Nuestro Catálogo
                </Link>
              </li>
              <li>
                <Link href="#nosotros" className="text-slate-400 font-light hover:text-[#22D3EE] transition-colors flex items-center gap-2 text-[14px] md:text-[15px]">
                  <ChevronRight className="w-4 h-4" /> Sobre Nosotros
                </Link>
              </li>
              <li>
                <Link href="#contacto" className="text-slate-400 font-light hover:text-[#22D3EE] transition-colors flex items-center gap-2 text-[14px] md:text-[15px]">
                  <ChevronRight className="w-4 h-4" /> Contacto
                </Link>
              </li>
              <li>
                <a href="https://instagram.com/kiszckarepuestos" target="_blank" rel="noopener noreferrer" className="text-slate-400 font-light hover:text-[#22D3EE] transition-colors flex items-center gap-2 text-[14px] md:text-[15px] group">
                  <svg 
          ...
          <div className="md:col-span-4 lg:col-span-4">
            <h4 className="text-base font-bold mb-5 text-white uppercase tracking-wider font-montserrat">Contacto Directo</h4>
            <div className="space-y-4">
              
              <a href="https://www.google.com/maps/search/?api=1&query=Av.+25+de+Mayo+1975,+Resistencia,+Chaco" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 group hover:opacity-80 transition-opacity">
                <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center flex-shrink-0 group-hover:bg-[#22D3EE]/20 transition-colors">
              ...
              <div className="flex items-center gap-3 group">
                ...
                <a href="https://wa.me/5493624540740" target="_blank" rel="noopener noreferrer" className="text-slate-300 text-[14px] md:text-[15px] hover:text-white transition-colors">
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-center md:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center gap-1.5 text-slate-400 group font-light">
            ...
            <a 
              ...
              className="text-white font-bold tracking-wide flex items-center gap-1.5 hover:text-[#22D3EE] transition-colors font-montserrat ml-1"
            >
              AFdevelopers
